...
<div class="iq-sidebar">
    ...
    <div id="sidebar-scrollbar">
       <nav class="iq-sidebar-menu">
          <ul id="iq-sidebar-toggle" class="iq-menu">
            <li>
               <a href="<?php echo e(route('admin.dashboard.index')); ?>" class="iq-waves-effect"><i class="las la-calendar iq-arrow-left"></i><span>Dashboard</span></a>
            </li>
            <li class="active">
 ...
 </div><?php /**PATH E:\xampp8.1\htdocs\sam\kanban\LaraMusicAdmin\resources\views/layouts/admin/sidebar.blade.php ENDPATH**/ ?>